...
Data available via \url{https://doi.org/10.5281/zenodo.17516319} (Zobitz
\& Zimmerman, 2025). Field-collected data, \texttt{neonSoilFlux}
calculated outputs, and manuscript-generating code are provided within
this repository.
...
\item
  ...
  ranging from 0.04 to 0.81 depending on calculation method used);
...
\includegraphics[width=0.6\textwidth,height=\textheight]{figures/r2-plot.png}
